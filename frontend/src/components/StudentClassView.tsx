  ...
  useEffect(() => {
    const fetchClasses = async () => {
      try {
        ...
        setError(
          err instanceof Error ? err.message : "Failed to load your classes",
        );
      } finally {
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
        ...
        >
                ...
                <tbody>
                  {filteredAssignment.map((a) => (
                    <tr key={a.AssignmentID}>
                      ...
                      <td>
                        {(() => {
                          const isSubmitted = submittedAssignments.has(
                            a.QuestID,
                          );
                          ...
                          if (!isSubmitted) {
                            ...
                            return (
                              <>
                                ...
                                <input
                                  ...
                                  style={{ display: "none" }}
                                  onChange={(e) =>
                                    handleFileChange(e, a.AssignmentID)
                                  }
                                />
                              </>
                            );
                          } else if (isGraded) {
                            // Submitted and graded - show view details button
                            return (
                              <button
                                className="btn-secondary"
                                style={{
                                ...
                                onClick={() => {
                                  // Scroll to submission details section
                                  const detailsElement =
                                    document.getElementById(
                                      `submission-details-${a.QuestID}`,
                                    );
                                  if (detailsElement) {
                            ...
                            // Submitted but not graded - show modify/reupload button
                            return (
                              <>
                                <label
                                  htmlFor={`resubmit-${a.AssignmentID}`}
                                  className="btn-secondary"
                                  style={{
                                    display: "inline-flex",
                                    alignItems: "center",
          ...
          {aiResults && (
            ...
            >
              <h3 style={{ fontSize: "1.125rem", margin: "0 0 16px 0" }}>
                AI Analysis Results
              </h3>
                ...
                >
                  <div
                    style={{
                      fontSize: "1.5rem",
                      fontWeight: "bold",
                      color: aiResults.plagiarism_flagged
                        ? "#ef4444"
                        : "#3b82f6",
                      marginBottom: "4px",
                    }}
                  ...
                  {submissions.map((submission, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div
                          id={`submission-details-${submission.quest_id}`}
                          style={{
                            backgroundColor: "var(--bg-surface)",
                            border: "1px solid var(--border)",
                            borderRadius: "var(--radius)",
                        ...
                        {status === "completed" ? (
                          ...
                          >
                            ...
                            >
                              Your submission is being analyzed for Gemini
                              Grade, Plagiarism Risk, and Draft Feedback.
                            </div>
                            <div
                              style={{
                                marginTop: "12px",
                          ...
                          >
                            ...
                            >
                              Your submission has been received and is queued
                              for AI analysis.
                            </div>
                          </div>
                        )}
